...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { city: @office.city, name: @office.name, state: @office.state } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { city: @office.city, name: @office.name, state: @office.state } }
